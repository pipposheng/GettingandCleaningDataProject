The average.txt output file includes 82 variables.

Column 1-2
"subject": the ID number of the subject (1-30)
"activity": the ID number of the activity (1-60)

Column 3-81 are numeric variables for each measurement
...
Column 82 is the activity name for each activity
"activityname": 
WALKING
WALKING_UPSTAIRS
WALKING_DOWNSTAIRS
